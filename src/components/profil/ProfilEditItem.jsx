      ...
      <ItemActions className="self-start">
        ...
        >
          ...
          <SheetContent className="overflow-x-auto">
            ...
            <Separator />
            <FieldGroup className="p-5 gap-6">
              <FormField
              ...
              {user?.role === FREELANCE && (
                <>
                  ...
                  <CustomFormField
                    ...
                    placeholder={t("modifierInfo.fields.site_web.placeholder")}
                    description={t("modifierInfo.fields.site_web.description")}
                    rules={{ max: 255 }}
                    icon={Globe}
                  />
              ...
              <FormItem>
                <FormLabel>{t("modifierInfo.fields.username.label")}</FormLabel>
