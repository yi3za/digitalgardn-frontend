          ...
          <FieldSet disabled={createServiceMutation.isPending}>
            <FieldGroup>
              ...
              <FormField
                ...
                control={form.control}
                render={({ field }) => {
                  const label = t("services.create.fields.description.label");
              ...
              <CustomFormField
                ...
                placeholder={t("services.create.fields.prix_base.placeholder")}
                control={form.control}
                icon={DollarSign}
                rules={{ min: 0 }}
                min={0}
              ...
              <CustomFormField
                ...
                placeholder={t("services.create.fields.revisions.placeholder")}
                control={form.control}
                icon={RotateCcw}
                rules={{ min: 0 }}
                min={0}
